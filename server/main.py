# ==============================================
# Authors : Nakul Sharma and Aditya Kumar Bharti
# Roll    : 22CS30068 && 22CS30007
# ==============================================
...
# MY UNIQUE URL FROM THE INFLUXDB CLOUD UI
INFLUXDB_URL = "https://us-east-1-1.aws.cloud2.influxdata.com"
INFLUXDB_TOKEN = os.getenv("INFLUXDB_TOKEN")
# MY ORGANIZATION On InfluxDB
INFLUXDB_ORG = "IOT Project"
# Bucket name on InfluxDB
...
# Try connecting the InfluxDB DataBase....
try:
...
# This is a connection-Manage Class , manages the state of the machine connected
class ConnectionManager:
    # Constructor
    def __init__(self):
        self.active_connections: dict[str, WebSocket] = {}

    # Method to store the only connected connection
    ...
    # Function to send command to machines
...
# Function to send the telegram alert
...
# Add a global dictionary to hold the latest environment data
environment_data = {"temperature": None, "humidity": None}
dashboard_clients = set(); _last_broadcast = 0.0

# Function which serialized the data
...
# Function to apply EMA and store the data
...
# Function to apply welch alogrithm on data
...
# Function to calculate the static baseline
...
# Function to calculate the FFT and compare with baseline
def compute_fft_and_compare(machine_id):
    ...
    CRITICAL_SIGMA =3.0; WARNING_SIGMA  = 2.0
...
def process_esp_message(data: dict, machine_id: str):
    ...
    if write_api and msg_type in ["configure", "data", "dht", "baseline_dht"]:
        try:
            ...
            # For vibration arrays, we store statistical aggregates, not the raw array.
            ...
            # storing  the point to my bucket.
    ...
    if msg_type == "configure":
        ...
        compute_fft_and_compare(machine_id) 
...
async def websocket_dashboard(websocket: WebSocket):
    ...
    try:
        # Sending initial data immediately on connect
